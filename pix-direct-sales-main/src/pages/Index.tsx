            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
              <div className="order-2 md:order-1">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">
                  <span className="block">Venda produtos digitais sem</span>
                  <span className="block text-[#8A2BE2]">complicação</span>
                </h1>
                <p className="text-lg md:text-xl text-[#CFCFCF] mt-6 max-w-xl">
                  Alta conversão, operação sem bloqueios, aprovação automática, saque rápido e integração direta com as principais ferramentas.
                </p>
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <Button className="bg-gradient-to-r from-[#8A2BE2] to-[#D34FE2] text-black font-semibold hover:opacity-90 px-6 py-6 text-base" onClick={() => navigate("/auth?signup=1")}>
                    Começar gratuitamente
                  </Button>
                  <Button variant="outline" className="border-[#8A2BE2]/40 text-white hover:bg-[#8A2BE2]/10 px-6 py-6 text-base" onClick={() => navigate("/auth?demo=1")}>
                    Agendar demo
                  </Button>
                </div>
